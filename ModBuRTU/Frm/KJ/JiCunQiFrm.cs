...
namespace SundyChengZhong.Frm.KJ
{
    public partial class JiCunQiFrm : BaseFuFrom
    {
        ...
        public List<CZJiCunQiModel> GetModel()
        {
            List<CZJiCunQiModel> kas = new List<CZJiCunQiModel>();
        ...
        {
            JiCunQiKJ kj = new JiCunQiKJ();
            kj.SetCanShu(new CZJiCunQiModel());
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (saveFileDialog.ShowDialog(this) == DialogResult.OK)
            {
                ...
                List<CZJiCunQiModel> cunmodekl = GetModel();
