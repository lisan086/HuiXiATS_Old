...
namespace ZhongWangSheBei.Frm
{
    public partial class PeiKJ : UserControl
    {
        ...
        public void SetCanShu(ZSModel model)
        {
            ...
            this.textBox4.Text = ZSCOMModel.ChaoShiTime.ToString();
            this.textBox5.Text = ZSCOMModel.XieRuChaoShi.ToString();
        ...
        public ZSModel GetCanShu()
        {
            ...
            model.ChaoShiTime= ChangYong.TryInt(this.textBox4.Text, 150);
            model.XieRuChaoShi = ChangYong.TryInt(this.textBox5.Text, 150);
            model.LisJiLu.Clear();
