...
namespace ModBuTCP.Frm
{
    public partial class JiCunQiKj : UserControl
    {
        ...
        public void SetCanShu(DataCunModel model)
        {
            ...
            this.textBox7.Text=model.BZhi.ToString();
            this.textBox8.Text = model.TeShuGongNengMa.ToString();
            this.textBox11.Text = model.IsHuiLing.ToString();
            this.textBox9.Text= model.HuiLingZhi.ToString();
            this.textBox10.Text = model.HuiLingYanShi.ToString();
            this.textBox12.Text = model.FenGeFu.ToString();
        }
        ...
        public DataCunModel GetCanShu()
        {
            ...
            model.BZhi= ChangYong.TryFloat(this.textBox7.Text, 0);
            model.TeShuGongNengMa = ChangYong.TryInt(this.textBox8.Text, 0);
            model.IsHuiLing = ChangYong.TryInt(this.textBox11.Text, 0);
            model.HuiLingYanShi = ChangYong.TryInt(this.textBox10.Text, 500);
            model.HuiLingZhi = this.textBox9.Text;
            model.FenGeFu= this.textBox12.Text;
            return model;
        }
